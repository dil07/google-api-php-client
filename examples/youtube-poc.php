...
echo pageHeader("YouTube - Fetch Channel Summary");
 ...
 * http://localhost:8080/youtube-poc.php
 ************************************************/
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $client->getAccessToken()) {
    $result = $service->channels->listChannels(
...
<?php else : ?>
  <form method="POST">
    <input type="submit" value="Click here to get youtube summary for the current account" />
  </form>
<?php endif ?>
</div>
